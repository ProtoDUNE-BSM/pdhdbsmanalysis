...
if [ $? -ne 0 ]; then
  ...
  lar -c run_analyzeEvents.fcl -s /exp/dune/data/users/dpullia/reco_files/nu_events/np04hd_raw_run029424_0020_dataflow1_datawriter_0_20241004T180407_reco_stage1_reco_stage2_20241004T211145_keepup.root 
